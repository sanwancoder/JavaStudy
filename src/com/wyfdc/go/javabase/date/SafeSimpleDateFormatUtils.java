package com.wyfdc.go.javabase.date;
...
public class SafeSimpleDateFormatUtils {
...
//                            System.out.println("thread: " + Thread.currentThread() + " init pattern: " + pattern);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread t1 = new Thread() {
            @Override
            public void run() {
                String s = SafeSimpleDateFormatUtils.format(new Date(), "yyyy-MM-dd");
        ...
        Thread t4 = new Thread() {
            ...
            public void run() {
                try {
                    Date s = SafeSimpleDateFormatUtils.parse("2017-06-10 12:00:01", "yyyy-MM-dd HH:mm:ss");
                    System.out.println(s);
